"""
Training script for experiment_1day_op_v3

This version predicts 1-day returns (percent moves) instead of raw Close.
It applies per-column normalisation (train split only) and keeps the
short-horizon forecast (2 days ahead).
"""
...
# CONFIGURATION
# ============================================================================
CSV_PATH = str(workspace_root / "data/resample/btcusd_1day_resampled.csv")
...
# Sequence lengths (1-day candle)
past_seq_len = 80   # 80 days lookback
future_seq_len = 2  # 2 days ahead
...
print("=" * 70)
print("EXPERIMENT 1DAY_OP_V3 - Training Configuration")
print("=" * 70)
